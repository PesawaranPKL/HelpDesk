        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?php base_url() ?>/dashboard" class="brand-logo">
                <img class="logo-abbr" width="66.5px" height="66.5px" src="/assets/images/logo/LogoHelp.png" alt="logo">
                <img class="brand-title" width="101.5px" height="29.5px" src="/assets/images/logo/LogoHelpText.png" alt="logo">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                                    <img src="/assets/images/client/client01.png" width="20" alt="">
